...
def publish_post(publish_id: str, caption: str = "", privacy_level: str = "MUTUAL_FOLLOW_FRIENDS", disable_comment: bool = False, disable_duet: bool = False, disable_stitch: bool = False):
    """
